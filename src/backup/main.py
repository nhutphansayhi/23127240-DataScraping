# main.py - Script chính để scrape papers từ arXiv
# MSSV: 23127240
...
class ArxivScraperPipeline:
    # Pipeline chính để scrape paper + references
    ...
    def __init__(self, output_dir: str, use_batch: bool = True):
        ...
        # Dùng batch API nhanh hơn nhiều (query 500 papers 1 lượt)
        if use_batch:
            ...
            logger.info("Dùng reference scraper bình thường")
